...
function display_page() {
    ...
    echo \block_lesson_notify\Base::page($CFG->wwwroot . '/blocks/lesson_notify/logs.php?courseid=' . $courseId, get_string('pluginname', 'block_lesson_notify'), get_string('logs', 'block_lesson_notify'), $context);

    $LOGS = new \block_lesson_notify\LessonLogs($courseId);
